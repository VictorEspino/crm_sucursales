            ...
            <div class="w-10/12 flex justify-center">
                <table class="table-auto">
                    ...
                    <tr class="bg-green-200 text-base font-semibold">
                        ...
                        <td class=""><center>{{$ac+$as}}</td>
                        <td class=""><center>{{$av_ac+$av_as}}</td>
                        <td class=""><center>{{number_format(intval($ac+$as)>0?100*($av_ac+$av_as)/($ac+$as):0,0)}}%</td>
                        <td class=""><center>{{-1*(($ac+$as)-($av_ac+$av_as))}}</td>
                    ...
                    <tr class="bg-green-200 font-semibold">
                        ...
                        <td class=""><center>{{$rc+$rs}}</td>
                        <td class=""><center>{{$av_rc+$av_rs}}</td>
                        <td class=""><center>{{number_format(intval($rc+$rs)>0?100*($av_rc+$av_rs)/($rc+$rs):0,0)}}%</td>
                        <td class=""><center>{{-1*(($rc+$rs)-($av_rc+$av_rs))}}</td>
        ...
        <div class="w-full flex justify-center rounded-b-lg bg-white px-4 flex flex-row">
            <div class="w-10/12 flex justify-center">
                <table class="table-auto">
                    ...
                    <tr class="bg-green-200 text-base font-semibold">
                        <td class="px-1">Activaciones</td>
                        <td class=""><center>{{number_format(($ac+$as)/2,0)}}</td>
                        <td class=""><center>{{$av_ac_q1+$av_as_q1}}</td>
                        <td class=""><center>{{number_format(intval(($ac+$as)/2)>0?100*($av_ac_q1+$av_as_q1)/(($ac+$as)/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($ac+$as)/2-($av_ac_q1+$av_as_q1)),0)}}</td>
                        <td class=""><center>{{intval(($ac+$as)/2)>0?number_format((100*15*($av_ac_q1+$av_as_q1)/($transcurridos>=15?15:$transcurridos))/(($ac+$as)/2),0):0}}%</td>
                    ...
                    <tr class="text-sm">
                        <td class="px-4">CON Equipo</td>
                        <td class=""><center>{{number_format($ac/2,0)}}</td>
                        <td class=""><center>{{$av_ac_q1}}</td>
                        <td class=""><center>{{number_format(intval($ac/2)>0?100*$av_ac_q1/($ac/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($ac/2)-$av_ac_q1),0)}}</td>
                        <td class=""><center>{{intval($ac/2)>0?number_format(100*15*$av_ac_q1/($transcurridos>=15?15:$transcurridos)/($ac/2),0):0}}%</td>
                    ...
                    <tr class="bg-gray-100 text-sm">
                        <td class="px-4">SIN Equipo</td>
                        <td class=""><center>{{number_format($as/2,0)}}</td>
                        <td class=""><center>{{$av_as_q1}}</td>
                        <td class=""><center>{{number_format(intval($as/2)>0?100*$av_as_q1/($as/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($as/2)-$av_as_q1),0)}}</td>
                        <td class=""><center>{{intval($as/2)>0?number_format((100*15*$av_as_q1/($transcurridos>=15?15:$transcurridos))/($as/2),0):0}}%</td>
                    ...
                    <tr class="bg-green-200 text-base font-semibold">
                        <td class="px-1">Renovaciones</td>
                        <td class=""><center>{{number_format(($rc+$rs)/2,0)}}</td>
                        <td class=""><center>{{$av_rc_q1+$av_rs_q1}}</td>
                        <td class=""><center>{{number_format(intval(($ac+$as)/2)>0?100*($av_rc_q1+$av_rs_q1)/(($rc+$rs)/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($rc+$rs)/2-($av_rc_q1+$av_rs_q1)),0)}}</td>
                        <td class=""><center>{{intval(($rc+$rs)/2)>0?number_format((100*15*($av_rc_q1+$av_rs_q1)/($transcurridos>=15?15:$transcurridos))/(($rc+$rs)/2),0):0}}%</td>
                    ...
                    <tr class="text-sm">
                        <td class="px-4">CON Equipo</td>
                        <td class=""><center>{{number_format($rc/2,0)}}</td>
                        <td class=""><center>{{$av_rc_q1}}</td>
                        <td class=""><center>{{number_format(intval($rc/2)>0?100*$av_rc_q1/($rc/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($rc/2)-$av_rc_q1),0)}}</td>
                        <td class=""><center>{{intval($rc/2)>0?number_format(100*15*$av_rc_q1/($transcurridos>=15?15:$transcurridos)/($rc/2),0):0}}%</td>
                    ...
                    <tr class="bg-gray-100 text-sm">
                        <td class="px-4">SIN Equipo</td>
                        <td class=""><center>{{number_format($rs/2,0)}}</td>
                            <td class=""><center>{{$av_rs_q1}}</td>
                            <td class=""><center>{{number_format(intval($rs/2)>0?100*$av_rs_q1/($rs/2):0,0)}}%</td>
                            <td class=""><center>{{number_format(-1*(($rs/2)-$av_rs_q1),0)}}</td>
                            <td class=""><center>{{intval($rs/2)>0?number_format(100*15*$av_rs_q1/($transcurridos>=15?15:$transcurridos)/($rs/2),0):0}}%</td>
            ...
            <div class="w-10/12 flex justify-center">
                <table class="table-auto">
                    ...
                    <tr class="bg-green-200 text-base font-semibold">
                        <td class="px-1">Activaciones</td>
                        <td class=""><center>{{number_format(($ac+$as)/2,0)}}</td>
                        <td class=""><center>{{($av_ac+$av_as)-($av_ac_q1+$av_as_q1)}}</td>
                        <td class=""><center>{{number_format(intval(($ac+$as)/2)>0?100*(($av_ac+$av_as)-($av_ac_q1+$av_as_q1))/(($ac+$as)/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($ac+$as)/2-(($av_ac+$av_as)-($av_ac_q1+$av_as_q1))),0)}}</td>
                        <td class=""><center>{{intval(($ac+$as)/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*(($av_ac+$av_as)-($av_ac_q1+$av_as_q1))/($transcurridos-15>0?$transcurridos-15:0))/(($ac+$as)/2),0):0}}%</td>
                    ...
                    <tr class="text-sm">
                        <td class="px-4">CON Equipo</td>
                        <td class=""><center>{{number_format($ac/2,0)}}</td>
                        <td class=""><center>{{$av_ac-$av_ac_q1}}</td>
                        <td class=""><center>{{number_format(intval($ac/2)>0?100*($av_ac-$av_ac_q1)/($ac/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($ac/2)-($av_ac-$av_ac_q1)),0)}}</td>
                        <td class=""><center>{{intval($ac/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*($av_ac-$av_ac_q1)/($transcurridos-15>0?$transcurridos-15:0))/($ac/2),0):0}}%</td>
                    ...
                    <tr class="bg-gray-100 text-sm">
                        <td class="px-4">SIN Equipo</td>
                        <td class=""><center>{{number_format($as/2,0)}}</td>
                        <td class=""><center>{{$av_as-$av_as_q1}}</td>
                        <td class=""><center>{{number_format(intval($as/2)>0?100*($av_as-$av_as_q1)/($as/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($as/2)-($av_as-$av_as_q1)),0)}}</td>
                        <td class=""><center>{{intval($as/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*($av_as-$av_as_q1)/($transcurridos-15>0?$transcurridos-15:0))/($as/2),0):0}}%</td>
                    ...
                    <tr class="bg-green-200 text-base font-semibold">
                        <td class="px-1">Renovaciones</td>
                        <td class=""><center>{{number_format(($rc+$rs)/2,0)}}</td>
                        <td class=""><center>{{($av_rc+$av_rs)-($av_rc_q1+$av_rs_q1)}}</td>
                        <td class=""><center>{{number_format(intval(($ac+$as)/2)>0?100*(($av_rc+$av_rs)-($av_rc_q1+$av_rs_q1))/(($rc+$rs)/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($rc+$rs)/2-(($av_rc+$av_rs)-($av_rc_q1+$av_rs_q1))),0)}}</td>
                        <td class=""><center>{{intval(($rc+$rs)/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*(($av_rc+$av_rs)-($av_rc_q1+$av_rs_q1))/($transcurridos-15>0?$transcurridos-15:0))/(($rc+$rs)/2),0):0}}%</td>
                    ...
                    <tr class="text-sm">
                        <td class="px-4">CON Equipo</td>
                        <td class=""><center>{{number_format($rc/2,0)}}</td>
                        <td class=""><center>{{$av_rc-$av_rc_q1}}</td>
                        <td class=""><center>{{number_format(intval($rc/2)>0?100*($av_rc-$av_rc_q1)/($rc/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($rc/2)-($av_rc-$av_rc_q1)),0)}}</td>
                        <td class=""><center>{{intval($rc/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*($av_rc-$av_rc_q1)/($transcurridos-15>0?$transcurridos-15:0))/($rc/2),0):0}}%</td>
                        <td class=""><center>${{number_format($rp_rc_q2,0)}}</td>
                        <td class=""><center>{{intval($total_movimientos-$total_movimientos_q1)>0?number_format(100*($av_rc-$av_rc_q1)/($total_movimientos-$total_movimientos_q1),0):0}}%</td>
                    </tr> 
                    <tr class="bg-gray-100 text-sm">
                        <td class="px-4">SIN Equipo</td>
                        <td class=""><center>{{number_format($rs/2,0)}}</td>
                        <td class=""><center>{{$av_rs-$av_rs_q1}}</td>
                        <td class=""><center>{{number_format(intval($rs/2)>0?100*($av_rs-$av_rs_q1)/($rs/2):0,0)}}%</td>
                        <td class=""><center>{{number_format(-1*(($rs/2)-($av_rs-$av_rs_q1)),0)}}</td>
                        <td class=""><center>{{intval($rs/2)>0 && $transcurridos-15>0?number_format((100*($total_dias-15)*($av_rs-$av_rs_q1)/($transcurridos-15>0?$transcurridos-15:0))/($rs/2),0):0}}%</td>
                        <td class=""><center>${{number_format($rp_rs_q2,0)}}</td>
                        <td class=""><center>{{intval($total_movimientos-$total_movimientos_q1)>0?number_format(100*($av_rs-$av_rs_q1)/($total_movimientos-$total_movimientos_q1),0):0}}%</td>
                    </tr>
                </table>
            </div>
            <div class="w-2/12">
